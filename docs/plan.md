...
## 1.1.Исходные данные (файл data.json):
валидный номер карты - 4444 4444 4444 4441 APPROVED

невалидный номер карты - 4444 4444 4444 4442 DECLINED
...
Поле «Владелец» - буквенные символы на русском языке, дефис, пробел.

Поле «CVC» - три цифры.

## 1.2. Позитивные тесты
